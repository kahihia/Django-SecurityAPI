...
The REST API provide programmatic access to read DataRadar.IO data.
...
Send me an email : contact@dataradar.io with a link to your twitter account (if you have one) and a link to your website (if you have one).
...
I will absolutely delighted to hear about them and will do my best to implement new ideas : contact@dataradar.io
